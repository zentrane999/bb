...
def check_and_update_member_quota(user_id):
    # Đổi %Y-%m-%Y thành %d-%m-%Y (Ngày-Tháng-Năm) chuẩn chỉnh
...
async def thong_tin_vip(update, context):
    ...
    if vip_cfg:
        ...
        # Sửa đồng bộ thành %d-%m-%Y ở cấu trúc kiểm tra thông tin thành viên thường
        current_date = datetime.now(timezone('Asia/Ho_Chi_Minh')).strftime('%d-%m-%Y')
...
async def xem_gia_vip(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Giao diện bảng giá tổng hợp 4 gói VIP phong cách Neon Cyber chuẩn tiếng Anh
    msg = (
        "⚡️ 💎 <b>[ CYBER STRESSERS VN - PREMIUM ]</b> 💎 ⚡️\n"
        "📢 ─── VIP MEMBERSHIP PRICING ─── 📢\n\n"
        
        "💛 <b>[ TIER: BASIC - VIP1 ]</b>\n"
        "🔹 <b>Price:</b> <code>99.000 VND</code> │ Month\n"
        "🔹 <b>Attack Time:</b> Max <code>60s</code> / Click\n"
        "🔹 <b>Daily Quota:</b> <code>30 Attacks</code> / Day\n"
        "🔹 <b>Max Concurrent:</b> <code>2 Slots</code>\n"
        "🔹 <b>Cooldown:</b> <code>30 seconds</code>\n"
        "❌ Auto-Spam │ ❌ Schedule Attack\n\n"
        
        "🤍 <b>[ TIER: PREMIUM - VIP2 ]</b>\n"
        "🔹 <b>Price:</b> <code>350.000 VND</code> │ Month\n"
        "🔹 <b>Attack Time:</b> Max <code>120s</code> / Click\n"
        "🔹 <b>Daily Quota:</b> <code>50 Attacks</code> / Day\n"
        "🔹 <b>Max Concurrent:</b> <code>2 Slots</code>\n"
        "🔹 <b>Cooldown:</b> <code>30 seconds</code>\n"
        "❌ Auto-Spam │ ❌ Schedule Attack\n\n"
        
        "💙 <b>[ TIER: DIAMOND - VIP3 ]</b>\n"
        "🔹 <b>Price:</b> <code>600.000 VND</code> │ Month\n"
        "🔹 <b>Attack Time:</b> Max <code>200s</code> / Click\n"
        "🔹 <b>Daily Quota:</b> <code>70 Attacks</code> / Day\n"
        "🔹 <b>Max Concurrent:</b> <code>3 Slots</code>\n"
        "🔹 <b>Cooldown:</b> <code>15 seconds</code>\n"
        "❌ Auto-Spam │ ✅ Schedule Attack (Enabled)\n\n"
        
        "❤️ <b>[ TIER: GOD MODE - VIP4 ]</b>\n"
        "🔹 <b>Price:</b> <code>1.000.000 VND</code> │ Month\n"
        "🔹 <b>Attack Time:</b> Max <code>300s</code> / Click\n"
        "🔹 <b>Daily Quota:</b> <code>100 Attacks</code> / Day\n"
        "🔹 <b>Max Concurrent:</b> <code>3 Slots</code>\n"
        "🔹 <b>Cooldown:</b> <code>15 seconds</code>\n"
        "✅ Auto-Spam │ ✅ Schedule Attack (Full Access)\n"
        "⚡️ ────────────────── ⚡️\n"
        "💳 <b>Contact Admin to Buy:</b> @zentra999 │ @anhba999\n"
        "💡 <i>Tap on Admin's username above to send a direct message!</i>"
    )
    
    kb = InlineKeyboardMarkup([
        [
            InlineKeyboardButton("💬 Buy via Admin 1", url="https://t.me/zentra999"),
            InlineKeyboardButton("💬 Buy via Admin 2", url="https://t.me/anhba999")
        ],
...
async def help_group(update, context):
    ...
    help_text = (
        "⚡️🚀<b>[ CYBER STRESSERS VN ]</b>🚀⚡️\n"
        "🎯 [ COMMAND CENTER / MAIN PANEL ]\n\n"
        f"👋 <b>Welcome:</b> @{username}\n\n"
        
        "⚔️ <b>FIRE CONTROL:</b>\n"
        "🧨 /attack » [method] [url] [time]\n"
        "🔄 /spam » [method] [url] [time]\n"
        "🛑 /stopspam » Dừng spam \n"
        "📅 /schedule » Lịch Trình [HH:MM]\n"
        "🗓 /schedule + spam » Lịch trình auto spam\n"
        "🗑 /delschedule » Xóa lịch trình [ID]\n"
        "🧯 /pkill » Emergency stop\n\n"
        
        "📡 CƠ SỞ DỮ LIỆU & TIỆN ÍCH:\n"
        "🪪 /me » Hồ sơ đặc quyền cá nhân\n"
        "💎 /price » Xem bảng giá VIP (Pricing)\n" # 👈 Thêm dòng này vào
        "🛰 /check » Trạng thái Host\n"
        "🧬 /methods » Phương pháp tấn công\n"
        "⚡️ ────────────────── ⚡️\n"
        "🎁 <b>REFERRAL PROGRAM:</b>\n"
        f"🔗 <code>{ref_link}</code>\n"
        "💡 Mời đồng đội tham gia bot để mở khóa gói VIP1 hoàn toàn MIỄN PHÍ!\n"
        "⚡️ ────────────────── ⚡️\n"
        "📶 <b>Status:</b> ONLINE │ 🔋 <b>Threads:</b> ACTIVE"
    )
...
async def tao_choi(update, context):
    ...
    dashboard = (
        ...
        "💥 <b>SYSTEM ENGAGED:</b>\n"
        f"🔹 <b>Operator:</b> @{escape(username)} ({user_id})\n"
        f"🔹 <b>Target:</b> <code>{url}</code>\n"
        f"🔹 <b>Method:</b> <code>{method_name.upper()}</code>\n"
        f"🔹 <b>Duration:</b> <code>{attack_time}s</code>\n\n"
        
        "👁‍🗨 <b>RECON & INTELLIGENCE:</b>\n"
        f"🔸 <b>IP Host:</b> <code>{ip}</code>\n"
        f"🔸 <b>Provider:</b> <i>{escape(isp_info.get('isp', 'N/A'))}</i>\n"
        "⚡️ ────────────────── ⚡️\n"
        f"📟 <b>System Time:</b> {get_thoi_gian_vn()}"
    )
    kb = InlineKeyboardMarkup([[
...
async def help_admin(update, context):
    ...
    msg = (
        "⚡️ 🛠 <b>[ CYBER STRESSERS VN - ADMIN ]</b> 🛠 ⚡️\n"
        "📢 ─── COMMAND CENTER v5.0 ─── 📢\n\n"
        ...
        "⚡️ ────────────────── ⚡️\n"
        "📶 <b>Master Core Connection:</b> ACTIVE"
    )
...
def main():
    ...
    app.add_handler(CommandHandler("price", xem_gia_vip)) # 👈 CHÈN DÒNG NÀY VÀO ĐÂY!
